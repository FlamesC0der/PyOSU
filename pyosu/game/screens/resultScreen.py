...
class ResultScreen:
    ...
    def render(self, screen: pygame.Surface):
        ...
        render_text(screen, f"{self.score['notes_values']['300']}x", font_name="AllerDisplay", size=35, position=(200, 250))

        s_100 = self.game.skin_manager.get_skin("hit100")
        s_100 = pygame.transform.scale(s_100, (50, 50))
        screen.blit(s_100, (100, 350))
        render_text(screen, f"{self.score['notes_values']['100']}x", font_name="AllerDisplay", size=35, position=(200, 350))

        s_50 = self.game.skin_manager.get_skin("hit50")
        s_50 = pygame.transform.scale(s_50, (50, 50))
        screen.blit(s_50, (100, 450))
        render_text(screen, f"{self.score['notes_values']['50']}x", font_name="AllerDisplay", size=35, position=(200, 450))
